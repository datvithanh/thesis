...
Qua 5 phần thực nghiệm trình bày ở trên, có thể thấy rằng việc xử lý dữ liệu bao gồm làm sạch dữ liệu giúp cải thiện mô hình đầu ra. Phương pháp kết hợp sử dụng transfer learing, khử tạp âm trong tín hiệu giọng nói, SGD, và AMP-arc (m=0.2) đạt 2.698\% EER cải thiện 3.152\% so với mô hình cơ sở với 5.860\% EER trên tập kiểm tra. 
